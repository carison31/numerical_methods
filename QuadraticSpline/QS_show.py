...
print(f"---5 узлов---")
print(f"Максимальное отклонение uni: {get_func_diff(0, 4, 511, f_3, qspline_uni_5):.3f}")
print(f"Максимальное отклонение opt: {get_func_diff(0, 4, 511, f_3, qspline_opt_5):.3f}")
...
print(f"---10 узлов---")
print(f"Максимальное отклонение uni: {get_func_diff(0, 4, 511, f_3, qspline_uni_10):.3f}")
print(f"Максимальное отклонение opt: {get_func_diff(0, 4, 511, f_3, qspline_opt_10):.3f}")
...
print(f"---25 узлов---")
print(f"Максимальное отклонение uni: {get_func_diff(0, 4, 511, f_3, qspline_uni_25):.3f}")
print(f"Максимальное отклонение opt: {get_func_diff(0, 4, 511, f_3, qspline_opt_25):.3f}")
...
print(f"---50 узлов---")
print(f"Максимальное отклонение uni: {get_func_diff(0, 4, 511, f_3, qspline_uni_50):.3f}")
print(f"Максимальное отклонение opt: {get_func_diff(0, 4, 511, f_3, qspline_opt_50):.3f}")
