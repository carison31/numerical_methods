...
cspline_opt_5 = cs.CubicSpline(5, svalues_matrix_opt_5)
cspline_uni_5 = cs.CubicSpline(5, svalues_matrix_uni_5)

ax[0, 0].set_title('5 узлов')
ax[0, 0].set_ylim([0.5, 1.7])
ax[0, 0].plot(x, cspline_uni_5(x))
ax[0, 0].plot(x, cspline_opt_5(x))
ax[0, 0].plot(x, f_3(x))
...
cspline_opt_10 = cs.CubicSpline(10, svalues_matrix_opt_10)
cspline_uni_10 = cs.CubicSpline(10, svalues_matrix_uni_10)


ax[0, 1].set_title('10 узлов')
ax[0, 1].set_ylim([0.5, 1.7])
ax[0, 1].plot(x, cspline_uni_10(x))
ax[0, 1].plot(x, cspline_opt_10(x))
ax[0, 1].plot(x, f_3(x))
...
cspline_opt_25 = cs.CubicSpline(25, svalues_matrix_opt_25)
cspline_uni_25 = cs.CubicSpline(25, svalues_matrix_uni_25)


ax[1, 0].set_title('25 узлов')
ax[1, 0].set_ylim([0.5, 1.7])
ax[1, 0].plot(x, cspline_uni_25(x))
ax[1, 0].plot(x, cspline_opt_25(x))
ax[1, 0].plot(x, f_3(x))
...
cspline_opt_50 = cs.CubicSpline(50, svalues_matrix_opt_50)
cspline_uni_50 = cs.CubicSpline(50, svalues_matrix_uni_50)


ax[1, 1].set_title('50 узлов')
ax[1, 1].set_ylim([0.5, 1.7])
ax[1, 1].plot(x, cspline_uni_50(x))
ax[1, 1].plot(x, cspline_opt_50(x))
ax[1, 1].plot(x, f_3(x))
